...
var chkNumeros = document.querySelector('.chk-num');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  btnGerarSenha.addEventListener("click", function () {
    var txtSenha = document.createElement('a');
    senhaGerada.appendChild(txtSenha);
    txtSenha.innerHTML = "".concat(gera());
  });
});
function gera() {
...
}; // gera numeros randomicos entre intervalos
var geraMaiuscula = function geraMaiuscula() {
  return String.fromCharCode(rand(65, 91));
}; // pega a função randomica pega um numero entre 65 a 91 e pega o caracter da tabela asc
var geraMinuscula = function geraMinuscula() {
  return String.fromCharCode(rand(97, 123));
}; // pega a função randomica pega um numero entre 97 a 123 e pega o caracter da tabela asc
var geraNumero = function geraNumero() {
  return String.fromCharCode(rand(48, 58));
}; //// pega a função randomica pega um numero entre 45 a 58 e pega o caracter da tabela asc
var simbolos = ',.^~[]{}!@#$%¨&*()_-/\\|=';
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\ninput[type=\"checkbox\"]{\n  width: 15px;\n  height: 15px;\n}\n.gerarSenha:hover{\n  background-color: #080808;\n  color:#fff;\n  border: 2px solid#fff;\n}\n.gerarSenha{\n  height: 2em;\n  border: 1px solid #040404;\n  border-radius: 05%;\n  background-color: #ffffff;\n}\n\n.container {\n  margin: 50px auto;\n  margin-left: 50px;\n  margin-right: 50px;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n.senha-gerada{\n  font-size: 1.5em;\n  color:var(--primary-color);\n  margin: 40px 0;\n}\n.text-titulo2{\n  padding-left: 12rem;\n  text-align: center;\n}\n.row{\n  display: grid;\n  grid-template-columns: 200px 200px 200px;\n}\n.resultado{\n  padding-inline-start: 14rem;\n}\n\nform input, form label, form button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n}\n\nform button:hover {\n  background: var(--primary-color-darker);\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;AACA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,yBAAyB;EACzB,UAAU;EACV,qBAAqB;AACvB;AACA;EACE,WAAW;EACX,yBAAyB;EACzB,kBAAkB;EAClB,yBAAyB;AAC3B;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,kBAAkB;EAClB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,gBAAgB;EAChB,0BAA0B;EAC1B,cAAc;AAChB;AACA;EACE,mBAAmB;EACnB,kBAAkB;AACpB;AACA;EACE,aAAa;EACb,wCAAwC;AAC1C;AACA;EACE,2BAA2B;AAC7B;;AAEA;EACE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;;AAGA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,uCAAuC;AACzC","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\ninput[type=\"checkbox\"]{\n  width: 15px;\n  height: 15px;\n}\n.gerarSenha:hover{\n  background-color: #080808;\n  color:#fff;\n  border: 2px solid#fff;\n}\n.gerarSenha{\n  height: 2em;\n  border: 1px solid #040404;\n  border-radius: 05%;\n  background-color: #ffffff;\n}\n\n.container {\n  margin: 50px auto;\n  margin-left: 50px;\n  margin-right: 50px;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n.senha-gerada{\n  font-size: 1.5em;\n  color:var(--primary-color);\n  margin: 40px 0;\n}\n.text-titulo2{\n  padding-left: 12rem;\n  text-align: center;\n}\n.row{\n  display: grid;\n  grid-template-columns: 200px 200px 200px;\n}\n.resultado{\n  padding-inline-start: 14rem;\n}\n\nform input, form label, form button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n}\n\nform button:hover {\n  background: var(--primary-color-darker);\n}\n"],"sourceRoot":""}]);
// Exports
